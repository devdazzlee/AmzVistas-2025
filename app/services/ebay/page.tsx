...
export default function EbayServicePage() {
  ...
  const features = [
    {
      ...
      description: "Create a stunning eBay store that builds trust and drives sales. We design custom storefronts with professional branding, optimized layouts, and compelling visuals that convert visitors into buyers.",
      color: "from-yellow-500 to-orange-600",
      image: "/images/services/ebay/enhanced/store-setup.jpg",
      benefits: ["Custom Design", "Brand Integration", "Mobile Optimization", "Trust Signals"]
    },
    {
      icon: Package,
      title: "Advanced Listing Management",
      description: "Optimize every listing for maximum visibility and sales. Professional descriptions, SEO-optimized titles, competitive pricing strategies, and high-quality images that showcase your products perfectly.",
      color: "from-blue-500 to-indigo-600",
      image: "/images/services/ebay/enhanced/listing-management.jpg",
      benefits: ["SEO Optimization", "Professional Copy", "Image Enhancement", "Pricing Strategy"]
    },
    {
      icon: TrendingUp,
      title: "Sales Performance Optimization",
      description: "Increase your conversion rate with strategic pricing, promotions, and listing enhancements. We analyze market trends and competitor data to maximize your sales potential.",
      color: "from-green-500 to-emerald-600",
      image: "/images/services/ebay/enhanced/sales-optimization.jpg",
      benefits: ["Market Analysis", "Competitor Research", "Pricing Optimization", "Promotion Management"]
    },
    {
      icon: Truck,
      title: "Complete Shipping Management",
      description: "Streamlined fulfillment and shipping solutions. We optimize your shipping strategy to reduce costs, improve delivery times, and enhance customer satisfaction.",
      color: "from-purple-500 to-pink-600",
      image: "/images/services/ebay/enhanced/shipping-management.jpg",
      benefits: ["Cost Optimization", "Delivery Tracking", "International Shipping", "Customer Service"]
    },
    {
      icon: Shield,
      title: "Account Health Protection",
      description: "Keep your seller account healthy and protected. We monitor all metrics, handle disputes professionally, and maintain your seller rating to ensure long-term success.",
      color: "from-red-500 to-rose-600",
      image: "/images/services/ebay/enhanced/account-protection.jpg",
      benefits: ["Metric Monitoring", "Dispute Resolution", "Policy Compliance", "Risk Management"]
    },
    {
      icon: Star,
      title: "Reputation Management",
      description: "Build and maintain an excellent seller reputation. We manage customer communications, resolve issues quickly, and implement strategies to generate positive feedback.",
      color: "from-cyan-500 to-blue-600",
      image: "/images/services/ebay/enhanced/reputation-management.jpg",
      benefits: ["Customer Service", "Issue Resolution", "Feedback Strategy", "Communication Management"]
    },
  ];

  const stats = [
    { value: "200", label: "Sellers Managed", suffix: "+" },
    { value: "25", label: "Million GMV", prefix: "$", suffix: "M+" },
    { value: "99.5", label: "Positive Feedback", suffix: "%" },
    { value: "50", label: "Sales Increase", suffix: "%+" },
  ...
  const benefits = [
    {
      icon: Clock,
      title: "Save 35+ Hours Weekly",
      description: "Focus on sourcing while we handle all eBay operations",
      color: "from-blue-500 to-cyan-500"
    },
    {
      icon: DollarSign,
      title: "Increase Revenue by 50%",
      description: "Our proven strategies drive significant sales growth",
      color: "from-green-500 to-emerald-500"
    },
    {
      icon: Shield,
      title: "100% Account Protection",
      description: "Complete protection for your seller account",
      color: "from-purple-500 to-pink-500"
    },
    {
      icon: Users,
      title: "Dedicated Support Team",
      description: "Personal account manager and expert eBay specialists",
      ...
      <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-yellow-600 via-orange-600 to-red-600">
        ...
        <div className="absolute inset-0">
          <div 
            ...
            style={{ backgroundImage: "url('/images/services/ebay/enhanced/banner-hero.jpg')" }}
          />
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-32">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              >
                <h2 className="text-xl font-semibold mb-4 text-white/90">Professional eBay Services</h2>
                <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-8 leading-tight">
                  eBay Store Management That Delivers
                </h1>
              </motion.div>
              ...
              >
                Maximize your eBay sales with expert store management. We handle everything from listing optimization to order fulfillment, helping you scale your eBay business profitably.
              </motion.p>
              ...
              >
                {["Full Management", "Global Reach", "Proven Results"].map((feature, index) => (
                  <motion.div
                    key={index}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <motion.h2 
              ...
              transition={{ duration: 0.8 }}
            >
              Complete eBay Store Management
            </motion.h2>
            <motion.p 
            ...
            >
              Everything you need to dominate eBay. Our comprehensive management covers every aspect of your eBay business from store setup to customer service.
            </motion.p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            ...
            <motion.p 
              ...
              transition={{ duration: 0.8, delay: 0.2 }}
            >
              Discover the advantages of selling on eBay's global marketplace
            </motion.p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <div className="space-y-8">
                {[
                  { icon: Globe, title: "Global Marketplace", desc: "Reach 182 million active buyers worldwide with international shipping capabilities" },
                  { icon: DollarSign, title: "High-Ticket Sales", desc: "Perfect platform for valuable items, collectibles, and unique products" },
                  { icon: TrendingUp, title: "Auction Format", desc: "Unique bidding system that can maximize prices beyond fixed pricing" },
                  { icon: BarChart3, title: "Lower Competition", desc: "Less saturated than Amazon with great opportunities for new sellers" },
                ].map((item, index) => {
            ...
            <motion.div 
              className="bg-gradient-to-br from-yellow-50 to-orange-50 rounded-3xl p-8"
              initial={{ opacity: 0, x: 50 }}
              animate={isLoaded ? { opacity: 1, x: 0 } : {}}
              transition={{ duration: 0.8, delay: 0.3 }}
            >
              <h3 className="text-3xl font-bold text-gray-900 mb-8">eBay Store Features</h3>
              <div className="space-y-4">
                {[
                  ...
                  <motion.div 
                    key={index} 
                    className="flex justify-between items-center p-4 bg-white rounded-xl shadow-lg"
                    whileHover={{ scale: 1.02, y: -2 }}
                    transition={{ duration: 0.2 }}
                  >
                    <span className="text-gray-700 font-medium text-lg">{item.feature}</span>
                    <span className="text-orange-600 font-bold text-lg">{item.value}</span>
                  </motion.div>
                ))}
              </div>
              <motion.button 
                className="w-full mt-8 bg-gradient-to-r from-yellow-600 to-orange-600 text-white font-bold py-4 rounded-xl hover:shadow-lg transition-all duration-300"
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <motion.h2 
              ...
              transition={{ duration: 0.8 }}
            >
              Why Choose Our eBay Management?
            </motion.h2>
            <motion.p 
