  ...
  const features = [
    {
      ...
      description: "Get approved to sell on Walmart Marketplace. We handle the application process and ensure you meet all requirements for successful approval.",
      color: "from-blue-500 to-cyan-600",
      image: "/images/services/walmart/enhanced/seller-approval.jpg",
      benefits: ["Application Process", "Requirements Check", "Documentation", "Approval Support"]
    },
    {
      icon: ShoppingCart,
      title: "Marketplace Setup",
      description: "Complete store setup and optimization. Product catalog integration, brand registry, and marketplace configuration for maximum visibility.",
      color: "from-green-500 to-emerald-600",
      image: "/images/services/walmart/enhanced/marketplace-setup.jpg",
      benefits: ["Store Configuration", "Catalog Integration", "Brand Registry", "Optimization"]
    },
    {
      icon: Package,
      title: "Product Listing",
      description: "Professional listings that convert. SEO-optimized titles, descriptions, and high-quality product images that drive sales.",
      color: "from-purple-500 to-pink-600",
      image: "/images/services/walmart/enhanced/product-listing.jpg",
      benefits: ["SEO Optimization", "Professional Descriptions", "High-Quality Images", "Sales Focus"]
    },
    {
      icon: Truck,
      title: "WFS Management",
      description: "Walmart Fulfillment Services optimization. Streamlined inventory and shipping management for efficient order processing.",
      color: "from-orange-500 to-red-600",
      image: "/images/services/walmart/enhanced/wfs-management.jpg",
      benefits: ["Inventory Management", "Shipping Optimization", "Order Processing", "Efficiency"]
    },
    {
      icon: Target,
      title: "Advertising Campaigns",
      description: "Sponsored product ads that drive sales. Strategic campaign management to maximize your ROAS and increase visibility.",
      color: "from-yellow-500 to-orange-600",
      image: "/images/services/walmart/enhanced/advertising-campaigns.jpg",
      benefits: ["Campaign Strategy", "ROAS Optimization", "Ad Management", "Visibility Boost"]
    },
    {
      icon: TrendingUp,
      title: "Performance Analytics",
      description: "Comprehensive analytics and reporting. Track sales performance, optimize strategies, and make data-driven decisions.",
      color: "from-indigo-500 to-purple-600",
      image: "/images/services/walmart/enhanced/performance-analytics.jpg",
      benefits: ["Sales Tracking", "Performance Reports", "Data Analysis", "Strategy Optimization"]
    },
  ];

  const stats = [
    { value: "300", label: "Walmart Sellers", suffix: "+" },
    { value: "95", label: "Approval Rate", suffix: "%" },
    { value: "250", label: "Sales Increase", suffix: "%" },
  ...
  const benefits = [
    {
      ...
      description: "Focus on your business while we handle all Walmart operations",
    ...
    {
      icon: Shield,
      title: "100% Walmart Compliant",
      description: "Stay compliant with all Walmart policies and requirements",
      color: "from-purple-500 to-pink-500"
    },
    {
      icon: Users,
      title: "Dedicated Walmart Team",
      description: "Specialists who understand the Walmart marketplace",
      ...
      <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-600">
        ...
        <div className="absolute inset-0">
          <div 
            ...
            style={{ backgroundImage: "url('/images/services/walmart/enhanced/banner-hero.jpg')" }}
          />
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              >
                ...
                <span className="text-lg font-medium">5.0 Rating • 300+ Happy Sellers</span>
              </motion.div>
              ...
              >
                <h2 className="text-xl font-semibold mb-4 text-white/90">Professional Walmart Management</h2>
              ...
              >
                Scale your business on Walmart Marketplace with our comprehensive management services. From seller approval to sales optimization, we handle everything.
              </motion.p>
              ...
              >
                <motion.button
                  className="bg-gradient-to-r from-blue-500 to-indigo-500 hover:from-blue-600 hover:to-indigo-600 text-white px-10 py-5 text-lg font-bold rounded-full shadow-2xl group border-2 border-blue-400 transition-all duration-300"
              ...
              >
                {["Seller Approval", "Marketplace Setup", "Sales Growth"].map((feature, index) => (
                  <motion.div
                    key={index}
                ...
                >
                  <div className="w-full h-full bg-gradient-to-br from-blue-500 to-indigo-600 rounded-2xl flex flex-col items-center justify-center">
                    ...
                    <div className="text-white text-center">
                      <div className="text-2xl font-bold mb-2">Walmart</div>
                      <div className="text-lg opacity-90">Marketplace</div>
                    </div>
                  </div>
                </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <motion.h2 
              ...
              transition={{ duration: 0.8 }}
            >
              Complete Walmart Management Services
            </motion.h2>
            <motion.p 
            ...
            >
              Everything you need to succeed on Walmart Marketplace. From approval to optimization, we handle it all.
            </motion.p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <motion.h2 
              ...
              transition={{ duration: 0.8 }}
            >
              Why Choose Our Walmart Service?
            </motion.h2>
            <motion.p 
              ...
              transition={{ duration: 0.8, delay: 0.2 }}
            >
              Experience the power of professional Walmart management
            </motion.p>
          </div>
