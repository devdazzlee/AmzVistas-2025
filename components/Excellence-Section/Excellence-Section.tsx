        ...
        >
          ...
          <div className="space-y-8 text-center max-w-3xl mx-auto">
            ...
            >
              ...
              of your Amazon automation investments at Amz Vistas, where pride meets innovation. Intrigued?
            </motion.p>
            ...
            <motion.p
              ...
              transition={{ type: "spring", stiffness: 400, damping: 10 }}
            >
             {` With Amz Vistas, you're not just getting a service provider but a team of   `}
              <motion.span
                className="font-semibold text-orange-500"
                whileHover={{ scale: 1.05 }}
                transition={{ type: "spring", stiffness: 400, damping: 10 }}
