...
export default function WebsiteDevelopmentPage() {
  ...
  const features = [
    {
      ...
      description: "Beautiful, modern designs tailored to your brand identity. No templates - every website is uniquely crafted to stand out, engage visitors, and convert them into customers.",
      color: "from-blue-500 to-indigo-600",
      image: "/images/website development/web-development.webp",
      benefits: ["Brand Integration", "Unique Design", "User Experience", "Visual Appeal"]
    },
    {
      icon: Smartphone,
      title: "Mobile-First Development",
      description: "Responsive designs that look perfect on every device and screen size. With over 60% of traffic coming from mobile devices, we ensure you capture every visitor.",
      color: "from-purple-500 to-pink-600",
      image: "/images/website development/Website-Development.webp",
      benefits: ["Responsive Design", "Mobile Optimization", "Touch-Friendly", "Cross-Platform"]
    },
    {
      icon: Zap,
      title: "Performance Optimization",
      description: "Lightning-fast websites optimized for speed and performance. Fast websites rank higher in search results, convert better, and keep visitors engaged longer.",
      color: "from-yellow-500 to-orange-600",
      image: "/images/website development/website-development-2022-12-15-23-25-34-utc-scaled.jpg.optimal.jpg",
      benefits: ["Speed Optimization", "Core Web Vitals", "Caching Strategy", "CDN Integration"]
    },
    {
      icon: ShoppingCart,
      title: "E-commerce Solutions",
      description: "Full-featured online stores that drive sales and grow your business. Secure payment processing, inventory management, and seamless checkout experiences.",
      color: "from-green-500 to-emerald-600",
      image: "/images/website development/blog-visuals-12.png",
      benefits: ["Payment Integration", "Inventory Management", "Order Processing", "Security"]
    },
    {
      icon: Lock,
      title: "Security & Reliability",
      description: "Enterprise-grade security and hosting solutions. SSL certificates, regular backups, malware protection, and 99.9% uptime guarantee for peace of mind.",
      color: "from-red-500 to-rose-600",
      image: "/images/website development/Top-Web-Development-Companies-in-Brighton.webp",
      benefits: ["SSL Certificates", "Regular Backups", "Malware Protection", "Uptime Monitoring"]
    },
    {
      icon: Settings,
      title: "Easy Content Management",
      description: "User-friendly CMS that you can update yourself without any coding knowledge. We provide comprehensive training and ongoing support to manage your content.",
      color: "from-cyan-500 to-blue-600",
      image: "/images/website development/images.jpg",
      benefits: ["User-Friendly CMS", "Content Training", "Easy Updates", "Ongoing Support"]
    },
  ];
  ...
  const benefits = [
    ...
    },
    {
      ...
      description: "Our optimized websites drive significant business growth",
      color: "from-green-500 to-emerald-500"
    },
    {
      icon: Shield,
      title: "100% Secure & Reliable",
      description: "Enterprise-grade security with guaranteed uptime",
      color: "from-purple-500 to-pink-500"
    },
    {
      icon: Users,
      title: "Dedicated Development Team",
      description: "Personal project manager and expert developers",
      ...
      <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-600">
        ...
        <div className="absolute inset-0">
          <div 
            ...
            style={{ backgroundImage: "url('/images/website development/programming-background-with-person-working-with-codes-computer_23-2150010125.jpg')" }}
          />
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              >
                ...
                <span className="text-lg font-medium">5.0 Rating • 400+ Happy Clients</span>
              </motion.div>
              ...
              >
                <h2 className="text-xl font-semibold mb-4 text-white/90">Professional Web Development</h2>
              ...
              >
                Transform your online presence with a website that's built to convert. We create fast, secure, and beautiful websites that turn visitors into customers and grow your business.
              </motion.p>
              ...
              >
                {["Custom Design", "Mobile-First", "SEO-Optimized"].map((feature, index) => (
                  <motion.div
                    key={index}
      ...
      <div className="py-24 bg-gradient-to-br from-gray-50 to-blue-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            ...
            >
              Everything you need for a powerful online presence. Our comprehensive web development services cover every aspect of modern website creation.
            </motion.p>
          </div>
            ...
            {[
              ...
              return (
                ...
                >
                  ...
                  <div className="text-blue-600 font-bold text-lg">{type.price}</div>
                </motion.div>
              );
            })}
          </div>
