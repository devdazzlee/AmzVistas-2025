...
export default function LogisticsTourSection({
  title = "Explore Orbit Syndicate logistics world with an exclusive tour of our Central Levittown facilities.",
  highlightedWords = ["Orbit Syndicate", "Central Levittown"],
  ...
  tourDescription = "Schedule your tour today for a firsthand experience of Orbit Syndicate's commitment to openness and innovation.",
